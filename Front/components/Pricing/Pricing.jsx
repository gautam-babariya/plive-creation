                        ...
                        <div class="pricing_card card">
                            <div class="card-body pricing_cardbody">
                                <h5 class="card-title pricing_cardtitle">Base plan<br></br>
                                    <p className='pricing_money'>₹ 2999</p></h5>
                            </div>
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item pricing_items">Delivered within 3 days<img src={check} alt="check" className="pricing_checkimg" /></li>
                            </ul>
